...
for(let i=1; i<=100; i++){              //Definizine del ciclo da 1 a 100
    ...
    if( (i%3==0) && (i%5==0) ){         //Numeri multipli di 3 e 5
        scatola.innerHTML += '<div class="col-2 m-4 text-center">' + 'FizzBuzz' + '</div>';
    
    }else if(i%3==0){                   //Numeri multipli di 3
        scatola.innerHTML += '<div class="col-2 m-4 text-center">' + 'Fizz' + '</div>';
    
    }else if(i%5==0){                   //Numeri multipli di 5
        scatola.innerHTML += '<div class="col-2 m-4 text-center">' + 'Buzz' + '</div>';
    
    }else{                              //Tutti gli altri
        scatola.innerHTML += '<div class="col-2 m-4 text-center">' + i + '</div>';
    }
}
